...
1. **Início de uma tarefa relevante** (feature, refatoração, mudança de arquitetura): o plano é escrito aqui como `docs/plannings/AAAA-MM-DD-titulo-curto.md`, antes de qualquer código ser alterado.
