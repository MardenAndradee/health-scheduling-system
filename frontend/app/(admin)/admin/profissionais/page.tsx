            ...
            <tbody>
              {filtered.map((p, i) => (
                ...
                >
                  ...
                  <td style={{ padding: '13px 16px', fontSize: 13, color: 'var(--accent)', whiteSpace: 'nowrap' }}>{p.especialidade}</td>
                  <td style={{ padding: '13px 16px', fontSize: 13, color: 'var(--muted)', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>{p.crm || '—'}</td>
                  <td style={{ padding: '13px 16px', fontSize: 13, color: 'var(--muted)', whiteSpace: 'nowrap' }}>{p.cargo || '—'}</td>
